...
import paishe from "../images/paishe.png";
    ...
    <div style={{ background: "#222", padding: 10, position: "relative" }}>
      <div style={{ height: 50, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <img alt="" style={{ width: 20, height: 20, objectFit: "contain" }} src={close}  onClick={()=>{
      ...
      <img alt="" style={{ width: 20, height: 20, position: "absolute", left: "50%", top: 150 }} src={paishe} />
      ...
      <div style={{ display: "flex", justifyContent: "space-between", position: 'relative' }}>
        ...
        <img alt="" style={{ width: 20, height: 20, position: "absolute", left: "60px", top: 5 }} src={paishe} />
