        ...
        <div>
            ...
            <ul className="nav mb-2 nav-tabs">
                {navList.map((item, index) =>
                                 <li className={item === 'Trending' ? "active nav-link"
                                                                    : "nav-link"}
                                     key={index}>{item}</li>
                )}
            </ul>
            <div className="poster-wrapper">
                <img style={{width: '100%'}}
                     src="https://cdnuploads.aa.com.tr/uploads/Contents/2020/05/30/thumbs_b_c_a4a6996640e91d4ff86a71f5d9d9f84b.jpg?v=225920"
                     alt=''/>
            </div>
            <PostSummaryList/>
        </div>
